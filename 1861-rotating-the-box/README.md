<h2><a href="https://leetcode.com/problems/rotating-the-box/?envType=problem-list-v2&envId=matrix">1972. Rotating the Box</a></h2><h3>Medium</h3><hr><p>You are given an <code>m x n</code> matrix of characters <code>boxGrid</code> representing a side-view of a box. Each cell of the box is one of the following:</p>
